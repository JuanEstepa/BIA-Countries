              ...
              {borderNames.length > 0 ? (
                borderNames.map((border) => (
                  <Link
                    ...
                    className="px-3 py-1 min-w-24 flex justify-center items-center bg-White dark:bg-DarkBlue rounded shadow text-sm mr-2 mb-2 hover:bg-gray-100 text-VeryDarkBlueText dark:text-White hover:dark:bg-VeryDarkBlueBg/80 transition"
                  >
                    {border.name}
                  </Link>
                ))
